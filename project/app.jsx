...
function Sidebar({ route }) {
  ...
  const isActive = (id) => {
    ...
    const map = {
      ...
      '/event-registry': 'sysevent_register', '/event-script-actions': 'sysevent_script_action',
      '/notification-templates': 'sysevent_email_template',
      '/event-match-rules': 'em_match_rule', '/alert-correlation-rules': 'em_alert_correlation_rule',
      '/alert-management-rules': 'em_alert_management_rule', '/alert-impact-rules': 'em_impact_rule',
      '/event-connectors': 'em_connector_definition', '/event-connector-instances': 'em_connector_instance',
    };
