  ...
  return (
    <div className="ref-page">
      ...
      <div className="ref-grid">
        <div className="cell"><div className="label">Department</div><div className="val">{window.findDepartment(r.department)?.name || '—'}</div></div>
        <div className="cell"><div className="label">Location</div><div className="val">{window.findLocation(r.location)?.name || '—'}</div></div>
        <div className="cell"><div className="label">Company</div><div className="val">{window.findCompany(r.company)?.name || '—'}</div></div>
        {(() => {
