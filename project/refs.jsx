  ...
  return (
    <div className="ref-page">
      ...
      <div className="ref-grid">
        ...
        <div className="cell"><div className="label">Location</div><div className="val">{r.location ? <a className="ref-link" onClick={() => window.navigate(window.recordUrl('cmn_location', r.location))}>{window.findLocation(r.location)?.name || r.__display_location || (String(r.location).slice(0, 8) + '…')}</a> : '—'}</div></div>
        {(() => {
  ...
  return (
    <div className="ref-page">
      ...
      <div className="ref-grid">
        ...
        <div className="cell"><div className="label">Location</div><div className="val">{c.location ? <a className="ref-link" onClick={() => window.navigate(window.recordUrl('cmn_location', c.location))}>{window.findLocation(c.location)?.name || c.__display_location || (String(c.location).slice(0, 8) + '…')}</a> : '—'}</div></div>
